        ...
        <div class="gap-1 px-6 flex flex-1 justify-center py-5">
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f4f2f0] px-10 py-3">
              <div class="flex items-center gap-8">
                ...
                <div class="flex items-center gap-9">
                  <a class="text-[#181411] text-sm font-medium leading-normal" href="#">Profile</a>
            ...
            <div class="px-4 py-3 @container">
              ...
              <style>
                          @container(max-width:120px){.table-47c2a25e-8e8a-467c-8886-8b69ef66eea4-column-120{display: none;}}
                @container(max-width:240px){.table-47c2a25e-8e8a-467c-8886-8b69ef66eea4-column-240{display: none;}}
                @container(max-width:360px){.table-47c2a25e-8e8a-467c-8886-8b69ef66eea4-column-360{display: none;}}
                @container(max-width:480px){.table-47c2a25e-8e8a-467c-8886-8b69ef66eea4-column-480{display: none;}}
              </style>
            </div>
