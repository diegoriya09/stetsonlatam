            ...
            <aside class="profile-sidebar">
                ...
                <nav class="sidebar-nav">
                    <a href="#" class="nav-link active" data-target="overview-panel">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 256 256"><path d="M224...Z"></path></svg>
                        <span>Overview</span>
                    </a>
                    <a href="#" class="nav-link" data-target="orders-panel">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 256 256"><path d="M247.42...Z"></path></svg>
                        <span>Orders</span>
                    </a>
                </nav>
            </aside>
                    ...
                    <div class="orders-table-container">
                        <table>
                            ...
                            <tbody id="orders-tbody">
                                <tr><td colspan="4" style="text-align: center; padding: 2rem;">Loading orders...</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
