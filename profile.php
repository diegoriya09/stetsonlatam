...
<body>
  <div class="relative flex size-full min-h-screen flex-col bg-white group/design-root overflow-x-hidden" style='font-family: "Noto Serif", "Noto Sans", sans-serif;'>
    <div class="layout-container flex h-full">
      ...
      <div class="layout-content-container flex flex-col flex-1 ml-80">
    ...
    <footer class="flex justify-center bg-[#f4f2f0]">
      <div class="flex max-w-[960px] flex-1 flex-col">
        <div class="flex flex-col gap-6 px-5 py-10 text-center">
          <div class="flex flex-wrap items-center justify-center gap-6">
            <a class="text-[#887563] text-base font-medium leading-normal hover:underline" href="#">FAQs</a>
            <a class="text-[#887563] text-base font-medium leading-normal hover:underline" href="#">Shipping &amp; Returns</a>
            <a class="text-[#887563] text-base font-medium leading-normal hover:underline" href="#">Privacy Policy</a>
          </div>
          <div class="flex flex-wrap justify-center gap-6 mt-4">
            <a href="#" class="text-[#887563] hover:text-[#181411]">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
                <path d="M128 0C57.31 0 0 57.31 0 128s57.31 128 128 128 128-57.31 128-128S198.69 0 128 0zm0 240c-61.86 0-112-50.14-112-112S66.14 16 128 16s112 50.14 112 112-50.14 112-112 112z"/>
              </svg>
            </a>
            <a href="#" class="text-[#887563] hover:text-[#181411]">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
          ...
          <p class="text-[#887563] text-sm font-normal leading-normal mt-6">© 2025 Stetson Latam. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
