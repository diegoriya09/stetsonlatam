      ...
      <div class="layout-container flex h-full grow flex-col">
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f3f2f2] px-10 py-3">
          <div class="flex items-center gap-8">
            <div class="flex items-center gap-4 text-[#151514]">
              ...
              <h2 class="text-[#151514] text-lg font-bold leading-tight tracking-[-0.015em]">Stetson Latin America</h2>
            </div>
            <div class="flex items-center gap-9">
              <a class="text-[#151514] text-sm font-medium leading-normal" href="#">New</a>
              <a class="text-[#151514] text-sm font-medium leading-normal" href="#">Men</a>
              <a class="text-[#151514] text-sm font-medium leading-normal" href="#">Women</a>
              <a class="text-[#151514] text-sm font-medium leading-normal" href="#">Hats</a>
              <a class="text-[#151514] text-sm font-medium leading-normal" href="#">Accessories</a>
              <a class="text-[#151514] text-sm font-medium leading-normal" href="#">Sale</a>
            </div>
          </div>
        ...
        <div class="px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div class="flex flex-wrap justify-between gap-3 p-4"><p class="text-[#151514] tracking-light text-[32px] font-bold leading-tight min-w-72">Hats</p></div>
