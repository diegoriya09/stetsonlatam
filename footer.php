         ...
         <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://x.com/dinalsom">
               <div class="text-[#3c3737]" data-icon="TwitterLogo" data-size="24px" data-weight="regular">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 256 256">
                     <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" />
                  </svg>
               </div>
            </a>
         </div>
         <p class="text-[#3c3737] text-base font-normal leading-normal">© 2025 Stetson Latam. Todos los derechos reservados.</p>
      </footer>
   </div>
</footer>
