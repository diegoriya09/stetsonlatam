        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f4f2f0] px-10 py-3">
          <div class="flex items-center gap-8">
            ...
            <div class="flex items-center gap-9">
              <a class="text-[#181411] text-sm font-medium leading-normal" href="#">Men</a>
              <a class="text-[#181411] text-sm font-medium leading-normal" href="#">Women</a>
              <a class="text-[#181411] text-sm font-medium leading-normal" href="hats.php">Hats</a>
              <a class="text-[#181411] text-sm font-medium leading-normal" href="#">Accessories</a>
              <a class="text-[#181411] text-sm font-medium leading-normal" href="#">Sale</a>
            </div>
          </div>
              ...
              <div class="flex flex-col justify-end gap-6 px-4 py-10 @[480px]:gap-8 @[480px]:px-10 @[480px]:py-20">
                ...
                <div class="flex flex-1 justify-center">
                  <div class="flex justify-center">
                    ...
                    >
                      <span id="user-modal">Sign Up</span>
                    </button>
                  </div>
                </div>
              </div>
