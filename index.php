      ...
      <div class="layout-container flex h-full grow flex-col">
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f5] px-10 py-3">
          <div class="flex items-center gap-8">
            <div class="flex items-center gap-4 text-[#111418]">
              ...
              <h2 class="text-[#111418] text-lg font-bold leading-tight tracking-[-0.015em]"><a href="index.html">Stetson Latin America</a></h2>
            </div>
            <div class="flex items-center gap-9">
              <a class="text-[#111418] text-sm font-medium leading-normal" href="#">Men</a>
              <a class="text-[#111418] text-sm font-medium leading-normal" href="#">Women</a>
              <a class="text-[#111418] text-sm font-medium leading-normal" href="hats.html">Hats</a>
              <a class="text-[#111418] text-sm font-medium leading-normal" href="#">Accessories</a>
              <a class="text-[#111418] text-sm font-medium leading-normal" href="#">Sale</a>
            </div>
          </div>
        ...
        <div class="px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <h2 class="text-[#111418] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Featured Products</h2>
            <div class="flex overflow-y-auto [-ms-scrollbar-style:none] [scrollbar-width:none] [&amp;::-webkit-scrollbar]:hidden">
              <div class="flex items-stretch p-4 gap-3">
                <div class="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  ...
                  ></div>
                  <div>
                    <p class="text-[#111418] text-base font-medium leading-normal">The Classic Stetson</p>
                    <p class="text-[#60758a] text-sm font-normal leading-normal">Our iconic hat, a symbol of American craftsmanship.</p>
                  </div>
                </div>
                <div class="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <div
                    class="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg flex flex-col"
                    style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuD_4bSW7T4MHdOUEUFfsiJ1H8T21Fwlhg5sEnxWw6vVyaj6vy5xs20lpEfrucnndQxFANjgs2x_1IPa5QJlla9uY6JZRPWkSkQoxsAHj2NYONDyWuO_aIZCdxuq3ybq1MI74ezCbCNZ4KQblWdb9aAV1aNNlHQKttdl1I3ZpMkGMrHGDQN-6mHWmhkm_AG40W4wSgHqYc2pxogYh_iMbdEAtiq7Xx7ezAPpHeSRzd5zyHoo8rhSpxOCV9OUZ-eF5CWNjnAGgQsvQA37");'
                  ></div>
                  <div>
                    <p class="text-[#111418] text-base font-medium leading-normal">Handcrafted Leather Belt</p>
                    <p class="text-[#60758a] text-sm font-normal leading-normal">Premium leather belt, perfect for any occasion.</p>
                  </div>
                </div>
                <div class="flex h-full flex-1 flex-col gap-4 rounded-lg min-w-60">
                  <div
                  ...
                  ></div>
                  <div>
                    <p class="text-[#111418] text-base font-medium leading-normal">Western Style Shirt</p>
                    <p class="text-[#60758a] text-sm font-normal leading-normal">Embrace the spirit of the West with our stylish shirts.</p>
                  </div>
                </div>
              </div>
            </div>
            <h2 class="text-[#111418] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">New Arrivals</h2>
            <div class="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              <div class="flex flex-col gap-3 pb-3">
                <div
                  class="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg"
                  style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuC0n9UT8RSB4SMQtGhKgvB7Ci_kElF7dDsjGbS6QjSBPMU562cBfYpecr3uyRNPvGgOSUgOb80LulYE-_OsFFjvOarkHiMK2UP-apbjz1UgXvOq14p2_gcYaH15qGOwh9Qrorrtc2yvzfG5WHPx6LkSaBXTpGXusQti-795A_MgVwt-N4YFFsCigQ1EnWEO2JCc0vx7X3KGSHu7ItM1ZFGgWEWt2Ir6PhmCR7ngGWgpXCn-N9sS6fX0WlUihywA6Aqc9x7-i67e1BeQ");'
                ></div>
                <div>
                  <p class="text-[#111418] text-base font-medium leading-normal">The Outlaw Collection</p>
                  <p class="text-[#60758a] text-sm font-normal leading-normal">Bold and rugged designs for the modern adventurer.</p>
                </div>
              </div>
              <div class="flex flex-col gap-3 pb-3">
                <div
                ...
                ></div>
                <div>
                  <p class="text-[#111418] text-base font-medium leading-normal">The Heritage Series</p>
                  <p class="text-[#60758a] text-sm font-normal leading-normal">Celebrating our rich history with classic styles.</p>
                </div>
              </div>
              <div class="flex flex-col gap-3 pb-3">
                <div
                  class="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-lg"
                  style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuBz5mD-6bflPGIqNfcO7EUyf9k9p7iyyVauQFflGMMyHJN4RVRRU_1wk_mqQDvbExzvukaAeRI-jgKi_OLbG64WtQvWooUdqd8ysO1XcJvd-0zuc4aOfr20UnjKK9FEW4KD8-v2BoH4DTo5_KRcRCR3tZrqOFS4wS_wTBATIEJ4uBl75ivV4gXI3xrE3WPqTnEhlOkJwXKEcqxCb-NaxxySHvRa4CyDvuDvC7aqTXrkrCmWWPJHs-5sky8NcBiUFDd6Bn3CZtkzcBU8");'
                ></div>
                <div>
                  <p class="text-[#111418] text-base font-medium leading-normal">The Urban Cowboy</p>
                  <p class="text-[#60758a] text-sm font-normal leading-normal">A contemporary take on Western fashion.</p>
                </div>
              </div>
            </div>
            <h2 class="text-[#111418] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Our Story</h2>
            ...
            <div class="@container">
              <div class="flex flex-col justify-end gap-6 px-4 py-10 @[480px]:gap-8 @[480px]:px-10 @[480px]:py-20">
                <div class="flex flex-col gap-2 text-center">
                  ...
                  <p class="text-[#111418] text-base font-normal leading-normal max-w-[720px">Stay up-to-date on the latest news, exclusive offers, and new product releases.</p>
                </div>
          ...
          <div class="flex max-w-[960px] flex-1 flex-col">
            <footer class="flex flex-col gap-6 px-5 py-10 text-center @container">
              <div class="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-around">
                ...
                <a class="text-[#60758a] text-base font-normal leading-normal min-w-40" href="#">Customer Service</a>
              ...
              <p class="text-[#60758a] text-base font-normal leading-normal">© 2024 Stetson Latin America. All rights reserved.</p>
            </footer>
          </div>
        </footer>
      </div>
