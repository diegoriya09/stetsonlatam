        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <div class="px-40 flex flex-1 justify-center py-5">
                <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                    <div class="@container">
                        <div class="@[480px]:p-4">
                            <div class="relative overflow-hidden flex min-h-screen flex-col items-center justify-center p-4">
                                ...
                                <div class="z-10 flex flex-col items-center gap-6">
                                    ...
                                    <a href="hats.php">
                                        <button class="flex h-12 px-5 rounded-lg bg-[#e68019] text-[#181411] font-bold">
                                            <span>Shop Now</span>
                                        </button>
                                    </a>
                                </div>
