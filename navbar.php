<header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f4f2f0] px-10 py-3">
    <div class="flex items-center gap-8">
        ...
        <div class="flex items-center gap-9">
            <a class="text-[#181411] text-sm font-medium leading-normal" href="index.php">New</a>
    ...
    <div class="flex flex-1 justify-end gap-8">
        ...
        <div class="flex gap-2">
            <button
                ...
                <div class="text-[#181411]" data-icon="Heart" data-size="20px" data-weight="regular"><a href="wishlist.php"></a>
