...
<div id="user-modal"
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="relative w-full max-w-md mx-auto bg-white rounded-2xl shadow-2xl p-8 animate-fade-in">
            <button type="button"
                class="close absolute top-4 right-4 text-3xl text-[#b0a99f] hover:text-[#3f1e1f] transition-colors"
                style="background:none;border:none;cursor:pointer;z-index:10001;">&times;</button>
            <h1 class="text-[#3c3737] text-2xl font-extrabold text-center mb-2">Welcome to Stetson Latam</h1>
            <div class="flex justify-center mb-6">
                <button id="switch-to-login"
                    class="px-4 py-2 font-bold border-b-2 border-[#3c3737] text-[#3c3737] focus:outline-none transition-colors">Login</button>
                <button id="switch-to-register"
                    class="px-4 py-2 font-bold border-b-2 border-transparent text-[#7a7671] focus:outline-none transition-colors">Register</button>
            </div>
            <script>
