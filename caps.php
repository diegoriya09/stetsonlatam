...
¡Claro que sí! Haremos exactamente lo mismo que con hats.php para darle a tu página de caps.php el mismo estilo
profesional y consistente.

El proceso es idéntico: no tocaremos tu lógica de PHP para los filtros, solo reorganizaremos el HTML y nos aseguraremos
de que cargue el CSS correcto.

## Paso 1: Añadir el CSS a caps.php
Primero, abre tu archivo caps.php. Dentro de la etiqueta

<head>, añade el enlace al archivo categoria.css para que pueda usar los estilos del banner y del grid de productos.
  ...
  ## Paso 2: Reemplazar el

<body> de caps.php
  Ahora, el paso más importante. Borra todo el contenido de tu archivo caps.php desde

  <body> hasta </body> y reemplázalo con este nuevo código completo.

  Este código ya incluye el nuevo banner y reorganiza tus filtros y productos en el nuevo formato.
